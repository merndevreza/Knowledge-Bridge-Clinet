      ...
      <div className="dark:bg-theme-dark bg-theme-light py-14 md:py-24 lg:py-28 px-2">
        <div className="dark:bg-theme-dark-top bg-white  max-w-3xl mx-auto px-6 md:px-12 py-10 md:py-20">
          ...
          >
            ...
            <div className="mb-3 rounded-md shadow-md p-4">
              <LoadCanvasTemplate />
              <input
                className="w-full font-medium mt-5 placeholder:font-normal placeholder:text-[#6c757d] border-b border-[#c9c9c9] focus:outline-none focus:border-[#615F5C]"
                type="text"
                name="captcha"
                ref={captchaRef}
              ...
              <button
                ...
                className="btn text-lg bg-theme-golden mt-5 text-white inline-block "
              >
                Validate
              </button>
            </div>
